    ...
    <SidebarProvider style={style as React.CSSProperties}>
      <div className="flex h-screen w-full overflow-hidden">
        ...
        <div className="flex flex-col flex-1 min-w-0">
          <header className="flex h-14 items-center justify-between gap-4 border-b px-4 bg-background shrink-0">
...
function Router() {
  ...
  return (
    <Switch>
      ...
      <Route path="/saude-frota">
        <AuthenticatedLayout>
          <ProtectedRoute component={FleetHealthPage} />
        </AuthenticatedLayout>
      </Route>
      <Route path="/km">
        <AuthenticatedLayout>
      ...
      <Route path="/contas-pagar">
        <AuthenticatedLayout>
          <ProtectedRoute component={PayablesPage} />
        </AuthenticatedLayout>
      </Route>
      <Route path="/contas-receber">
        <AuthenticatedLayout>
          <ProtectedRoute component={ReceivablesPage} />
        </AuthenticatedLayout>
      </Route>
      <Route path="/financeiro">
        <AuthenticatedLayout>
          <ProtectedRoute component={FinancialSummaryPage} />
        </AuthenticatedLayout>
      </Route>
      <Route path="/rotas">
        <AuthenticatedLayout>
